...
Personally, I have started using [Open WebUI](https://openwebui.com/) and locally hosted models via [Ollama](https://ollama.com/) for a vast majority of my brain dump needs and if you're a tech-savvy person, I think you should do the same. Research over the web still seems very tough without using a tool like Perplexity.
